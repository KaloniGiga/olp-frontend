...
import { Button, Group, Paper, RangeSlider, Select, Stack, Text, Title, createStyles } from '@mantine/core';
...
function NewFourthForm({prevStep, nextStep, fourthForm}) {
  ...
  const handleSubmit = (value) => {
        ...
        // }
         ...
         axiosInstance.post('/users/preferance-detail', value)
          .then((response) => {
...
const [casteOptions, setCasteOptions ] = useState([
 ...
 const [motherTongueOptions, setMotherTongueOptions ] = useState([
  ...
  const mediumDesktop = useMediaQuery('(max-width: 1440px)')
    ...
    useEffect(() => {
      const targetCaste = casteOptions.find((caste) => caste.value == fourthForm.values.caste);
      console.log(targetCaste)
      if(!targetCaste && fourthForm.values.caste) {
         setCasteOptions([...casteOptions, {value: fourthForm.values.caste, label: fourthForm.values.caste}])
      }
  }, [fourthForm])
  
   useEffect(() => {
      const targetReligion = religionOptions.find((religion) => religion.value == fourthForm.values.religion);
      if(!targetReligion && fourthForm.values.religion) {
         setReligionOptions([...religionOptions, {value: fourthForm.values.religion, label: fourthForm.values.religion}])
      }
  }, [fourthForm])

    useEffect(() => {
      const targetCaste = educationQualificationOptions.find((caste) => caste.value == fourthForm.values.education_degree);
      console.log(targetCaste)
      if(!targetCaste && fourthForm.values.education_degree) {
         setEducationQualificationOptions([...casteOptions, {value: fourthForm.values.education_degree, label: fourthForm.values.education_degree}])
      }
  }, [fourthForm])
  
   useEffect(() => {
      const targetSubject = subjectOptions.find((subject) => subject.value == fourthForm.values.subject);
      if(!targetSubject && fourthForm.values.subject) {
         setSubjectOptions([...subjectOptions, {value: fourthForm.values.subject, label: fourthForm.values.subject}])
      }
  }, [fourthForm])

  useEffect(() => {
      const targetMotherTongue = motherTongueOptions.find((motherTongue) => motherTongue.value == fourthForm.values.motherTongue );
      if(!targetMotherTongue && fourthForm.values.motherTongue) {
        setMotherTongueOptions([...motherTongueOptions, {value: fourthForm.values.motherTongue, label: fourthForm.values.motherTongue}])
      }
  }, [fourthForm])
      ...
      {/* <h1 className="text-2xl w-full text-center font-semibold xl:text-4xl my-4">Some Personal details</h1> */}
        ...
        <Paper className={classes.formWrapper}  withBorder radius={2} py={30} px={30}>
          {/* <form className=" mx-auto" onSubmit={(e) => handleSubmit(e)}> */}
            ...
            <Title order={largeDesktop ? 1 : (mediumDesktop ? 3 : 2)} ta="center" mt="md" mb={'md'}>Preferance Detail</Title> 
          ...
          <form className="mx-auto" onSubmit={fourthForm.onSubmit(handleSubmit)}>
           ...
           <Group grow mb={largeDesktop ? 'md' : 'sm'}>
            <Select value={fourthForm.values.minAge} onChange={(value) => fourthForm.setFieldValue('minAge', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Min Age" placeholder='From' searchable data={fromAgeOptions}/>
             <Select value={fourthForm.values.maxAge} onChange={(value) => fourthForm.setFieldValue('maxAge', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Max Age" placeholder='To' searchable  data={toAgeOptions} />
           </Group>
            {/* </Stack>  */}
          ...
          <Group grow mb={largeDesktop ? 'md' : 'sm'}>
            <Select value={fourthForm.values.minHeight} onChange={(value) => fourthForm.setFieldValue('minHeight', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Min Height" placeholder='From' searchable data={fromheightOptions}/>
             <Select value={fourthForm.values.maxHeight} onChange={(value) => fourthForm.setFieldValue('maxHeight', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Max Height" placeholder='To' searchable  data={toheightOptions} />
           </Group>
          ...
          <Group grow mb={largeDesktop ? 'xl' : (mediumDesktop ? 'md' : 'lg')}> 
                 ...
                 getCreateLabel={(query) => `+Create ${query}`}
                  value={fourthForm.values.religion} onChange={(value) => fourthForm.setFieldValue('religion', value)} required searchable creatable label="Religion" placeholder='Select preferred Religion' size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} data={religionOptions} />
                 <Select
                   onCreate={(query) => {
                             const item = { value: query, label: query};
                 ...
                 getCreateLabel={(query) => `+Create ${query}`}
                  value={fourthForm.values.caste} onChange={(value) => fourthForm.setFieldValue('caste', value)} required searchable creatable label="Caste" placeholder='Select Preferred Caste' size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} data={casteOptions} />
           </Group>
{/* 
           ...
           <Group grow mb={largeDesktop ? 'xl' : (mediumDesktop ? 'md' : 'lg')}> 
                 ...
                 getCreateLabel={(query) => `+Create ${query}`}
                  value={fourthForm.values.education} onChange={(value) => fourthForm.setFieldValue('education', value)} required searchable creatable label="Education Qualification" placeholder='Enter educational qualification' size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} data={educationQualificationOptions} />
                 <Select
                   onCreate={(query) => {
                             const item = { value: query, label: query};
                 ...
                 getCreateLabel={(query) => `+Create ${query}`}
                 value={fourthForm.values.subject} onChange={(value) => fourthForm.setFieldValue('subject', value)} required searchable creatable label="subject" placeholder='Enter Subject' size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} data={subjectOptions} />
           </Group>
         ...
         <Group grow mb={largeDesktop ? 'md' : 'sm'}>
            <Select value={fourthForm.values.sector} onChange={(value) => fourthForm.setFieldValue('sector', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Sector" placeholder='Enter Sector' searchable creatable data={sectorOptions}/>
             <Select value={fourthForm.values.annualIncome} onChange={(value) => fourthForm.setFieldValue('annualIncome', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Annual Income" placeholder='Enter annual Income' searchable  data={annualIncomeOptions} />
        </Group>
         ...
         <Group grow mb={largeDesktop ? 'md' : 'sm'}>
            <Select value={fourthForm.values.maritalStatus} onChange={(value) => fourthForm.setFieldValue('maritalStatus', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Marital Status" placeholder="Select Marital Status" searchable data={maritalStatusOptions}/>
             <Select
               onCreate={(query) => {
                             const item = { value: query, label: query};
                 ...
                 getCreateLabel={(query) => `+Create ${query}`}
              value={fourthForm.values.motherTongue} onChange={(value) => fourthForm.setFieldValue('motherTongue', value)} size={largeDesktop ? 'xl': (mediumDesktop ? 'sm' : 'lg')} label="Mother Tongue" placeholder='Enter Mother Tongue' searchable creatable data={motherTongueOptions} />
           </Group>

     <Group position="center" mt="xl">
        <Button className={classes.button} variant="outline" onClick={prevStep}>Back</Button>
        <Button type='submit' className={classes.button} style={{backgroundColor: 'var(--secondary)'}} variant="filled">Next</Button>
      </Group>
