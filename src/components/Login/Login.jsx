                ...
                <form className="form_feild" onSubmit={(e) => handleSubmit(e)}>
                  ...
                  <p className='py-2'>
                    ...
                    {/* <input
                      ...
                      className="input_field px-3 py-1 text-sm"
                      type="text"
                      value={username}
                 ...
                 <button className="form_btn bg-[var(--primary)] w-[90%] md:w-[80%]" type="submit">
                     Login
                  </button>

                  <div className='w-[90%] md:w-[80%] md:mt-2 mx-auto flex justify-between'>
                     <p className=" mt-2 ">
                      ...
                      <p className='text-[var(--secondary)]'>
                       <Link to={'/register'} className='md:text-xl'>Don't have a account</Link>
                      </p>
                   </div>
                </form>
              </div>
