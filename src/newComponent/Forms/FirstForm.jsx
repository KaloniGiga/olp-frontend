...
function FirstForm({firstFormValues, setFirstFormValues, currentFormCount, setCurrentFormCount}) {
         ...
         <div className="mt-16 min-h-full mb-8 px-2 py-4  w-[90%] md:w-[80%] lg:w-[70%] xl:w-[65%] bg-white  rounded-lg mx-auto">
          ...
          <form className=" mx-auto" onSubmit={(e) => handleSubmit(e)}>
             ...
             <div className="w-full flex  justify-around items-center">
               <Input value={firstFormValues.fullname} onChange={(e) => handleInputChange(e)} name="fullname" label="Full Name" classes3="w-[40%]" classes="px-2" classes2="block lg:text-lg xl:text-xl" type="text" placeholder="Enter full Name" />
               <InputSelect value={firstFormValues.profileCreatedFor} onChange={handleProfileForChange}  label="Profile for " classes1="block text-md lg:text:lg xl:text-xl my-2" classes2="xl:w-[40%] basis-[40%]" options={profileOptions}/>

             </div>

           <div className="w-full flex  justify-around items-center">
              <InputSelect value={firstFormValues.sex} onChange={handleGenderChange}  label="Gender " classes1="block text-xl my-2" classes2="xl:w-[40%] basis-[40%]" options={genderOptions} />
               ...
               <InputSelect value={firstFormValues.religion} onChange={handleReligionChange} label="Religion " classes1="block text-md lg:text-lg xl:text-xl my-2" classes2="xl:w-[70%] basis-[40%]" options={religionOptions}/>
           </div>
           ...
           <div className="w-full flex justify-around  items-center">
               ...
               <InputSelect value={firstFormValues.caste} onChange={handleCasteChange} label="Caste" classes1="block text-xl my-2" classes2="xl:w-[40%] basis-[40%]" options={casteOptions}/>
               {/* <Input label="Sub Caste" type="text" classes3="w-[70%]" classes1="block text-2xl my-2" classes2="xl:w-[70%] basis-[70%]" /> */}
                <Input name="subcaste" value={firstFormValues.subcaste} onChange={handleInputChange} label="Sub Caste" classes3="w-[40%]" classes="px-2" classes2="block xl:text-xl lg:text-xl" type="text" placeholder="Enter your Sub Caste" />
           </div>
            ...
            <div className='w-[90%] flex justify-between mx-auto'>
               ...
               <InputSelect value={firstFormValues.year} onChange={handleYearChange} label="Year" classes1="block text-md lg:text-lg xl:text-xl my-2" classes2="xl:w-[30%] basis-[30%]" options={maritalStatusOptions}/>
               </div>
         
        
           <div className="w-full flex justify-around  items-center"> 
               <Input value={firstFormValues.address} onChange={handleInputChange} name="address" label="Where do you live ?" classes3="w-[40%]" classes="px-2" classes2="block xl:text-xl xl:text-xl lg:text-lg" type="text" placeholder="Enter your current address" />
               <InputSelect value={firstFormValues.marital_status} onChange={handleMaritalStatusChange} label="Marital Status" classes1="block text-md lg:text-lg xl:text-xl my-2" classes2="xl:w-[40%] basis-[40%]" options={maritalStatusOptions}/>
           </div>

             <div className="w-full flex justify-around  items-center"> 
              <InputSelect value={firstFormValues.height}  onChange={handleHeightChange} label="Your Height " classes1="block text-md lg:text-lg xl:text-xl my-2" classes2="xl:w-[40%] basis-[40%]" options={heightOptions} />
               ...
               <InputSelect value={firstFormValues.physicalDisability} onChange={handlePhysicalDisabilityChange} label="Any Disability" classes1="block text-md lg:text-lg xl:text-xl my-2" classes2="xl:w-[40%] basis-[40%]" options={disabilityOptions} />
           </div>
          ...
          <div className="w-full flex justify-center">
             ...
             <Button type="submit"
              // onClick={handleNextClick}
               label="Next" classes="px-16 py-3 rounded-xl btnnext text-white" classes2="w-full flex justify-center py-4" />
          </div> 
