...
import { acceptConnectionRequestThunk, rejectConnectionRequestThunk } from '../../store/thunk/connectionsThunk';
...
function ConnectionRequestCard(props) {
    ...
    const handleRequestAccept = () => {
       dispatch(acceptConnectionRequestThunk(props && props.connectionRequest.id))
    }
  ...
  return (
      <div className="searchedlist bg-white mx-2 px-2 border-b-[1px] border-[rgba(0,0,0,0.4)]">
     ...
     <div className="searchedlist-right">
        ...
        <div className="user-details">
            <div className="user-details-left">
                <p>24 <span>5.6ft</span></p>
                <p>Hindu, <span>Brahm</span></p>
                {/* <p>{value.education}</p> */}
            ...
            <div className="user-details-right">
               <button  onClick={() => handleRequestAccept()}  className="searchedlist-outline-btn">Accept</button> 
                <button onClick={() => handleRequestReject()}  className="searchedlist-btn">Ignore</button>
            </div>
        </div>
     </div>
      </div>
