...
function NotificationCreateConnectionRequest({notification}) {
      ...
      <Stack spacing={5}>
        ...
        <Image src={connectImage} width={15}  />
         ...
         <Group spacing={5}>
          ...
          <Button px={'xl'} size='sm'  variant="filled" style={{backgroundColor: 'var(--secondary)'}} onClick={() => handleCallback()}>View</Button>
           <Button px={'xl'} size='sm'  variant="outline"  onClick={() => handleNotificationDelete()}>Delete</Button>
          </Group>
          </Flex>
         {/* <BsThreeDots size={25} /> */}
       </Flex>
...
export default NotificationCreateConnectionRequest;