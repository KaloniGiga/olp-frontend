         ...
         <MyProfiles/>        
          ...
          <div className="chat mt-4">
             <div className="chat-name">
                ...
                <h5>Sunder Pichai <div className="chat-online-offline"></div></h5>
             ...
             <div className="message-box">
               ...
               <div className="chat-box-left"> 
                <img src="https://www.circumcisionpro.co.uk/wp-content/uploads/2021/05/avatar-profile-picture.jpg" alt="chat-profile" />
                <p> I feel like we have something really special together, and I want to take things to the next level.</p>
               </div>
               ...
               <div className="chat-box-right">
                <p> I feel the same way and I want to make sure we're both on the same page.</p>
               <img src="https://www.circumcisionpro.co.uk/wp-content/uploads/2021/05/avatar-profile-picture.jpg" alt="chat-profile" />
               </div>
               <div className="chat-box-left"> 
                <img src="https://www.circumcisionpro.co.uk/wp-content/uploads/2021/05/avatar-profile-picture.jpg" alt="chat-profile" />
                <p> Of course, I understand. I just think that we're ready for this step.</p>
               </div>
               <div className="chat-box-right">
                <p>That's true. But what about our careers and our future plans? We need to make sure we're on the same page about those things too.</p>
               <img src="https://www.circumcisionpro.co.uk/wp-content/uploads/2021/05/avatar-profile-picture.jpg" alt="chat-profile" />
               </div>
               <div className="chat-box-left"> 
                <img src="https://www.circumcisionpro.co.uk/wp-content/uploads/2021/05/avatar-profile-picture.jpg" alt="chat-profile" />
                <p>  Absolutely. I think we should sit down and talk about our goals and how we see our lives together. But ultimately, I just want to spend the rest of my life with you.</p>
               </div>
               <div className="chat-box-right">
                <p>That's all I needed to hear. Yes, let's talk about our future together and make sure we're ready for this step. But I can't imagine spending my life with anyone else but you.</p>
               <img src="https://www.circumcisionpro.co.uk/wp-content/uploads/2021/05/avatar-profile-picture.jpg" alt="chat-profile" />
               </div>
             </div>
             </div>
