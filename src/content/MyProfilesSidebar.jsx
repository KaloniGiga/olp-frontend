              ...
              <div className="viewprofile-box">
                {selectedFile ? (
                  <img
                    ...
                    onClick={showimage}
                    alt="profile pic"
                    className="viewprofile-box-pp"
                  />
                ) : (
                  ""
                )}
                <div className="viewprofileupdate-box" onClick={handleClick}>
                  <AiOutlineCamera />
                </div>
                <input
                  type="file"
            ...
            <div className="profile-form pt-4">
              <div className="profile-form-left pt-4">
                ...
                <ul>
                  <li>
                    <Link>
                      <BsFillPeopleFill className="myprofileside-left-icon" />{" "}
                      Connected<div className="badge1"></div>{" "}
                    </Link>{" "}
                  </li>
                  <li>
                    <Link>
                      <i className="bi bi-chat-heart"></i> Messages{" "}
                      <div className="badge1"></div>
                    </Link>
                  </li>
                  <li>
                    <Link>
                      <MdNotifications className="myprofileside-left-icon" />{" "}
                      Notification <div className="badge1"></div>
                    </Link>
                  </li>
                  <li>
                    <Link>
                      <MdEventAvailable className="myprofileside-left-icon" />{" "}
                      Events{" "}
                    </Link>
                  </li>
                  <li>
                    <Link>
                      <AiFillSetting className="myprofileside-left-icon me-2" />
                      Settings
                    </Link>
                  </li>
                </ul>
